...
class MyTet extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    var tetGeom = new THREE.TetrahedronGeometry(4,0);
    // Como material se crea uno a partir de un color
    var tetMat = new THREE.MeshPhongMaterial({color: 0xCF0000});
    var meshMaterial = new THREE.MeshNormalMaterial({color: 0x7777ff});
    // Ya podemos construir el Mesh
    var tet = new THREE.Mesh (tetGeom, meshMaterial);
